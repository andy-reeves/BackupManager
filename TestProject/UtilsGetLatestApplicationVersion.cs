...
public sealed class UtilsGetLatestApplicationVersion
{
    ...
    public void GetVersionNumber()
    {
        ...
        Assert.Equal("1.40.0.7996", Utils.GetApplicationVersionNumber(ApplicationType.PlexPass));
    ...
    public void GetLatestApplicationVersionNumber()
    {
        ...
        Assert.Equal(Utils.Config.PlexToken.HasValue() ? "1.40.0.7996" : "1.32.8.7639",
