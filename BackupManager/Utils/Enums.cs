...
public static class Enums
{
    ...
    {
        string description;
        if (EnumInternals<T>.ValueToDescriptionMap.TryGetValue(item, out description)) return description;
    ...
    ///     false otherwise.
    /// </returns>
    public static bool TryParseDescription<T>(string description, out T value) where T : struct
    {
