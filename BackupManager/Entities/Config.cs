...
namespace BackupManager.Entities
{
    ...
    public class Config
    {
        ...
        public Collection<string> MasterFolders { get; set; }

        [XmlArrayItem("IndexFolder")]
        public Collection<string> IndexFolders { get; set; }

        [XmlArrayItem("FilterRegEx")]
        public Collection<string> Filters { get; set; }

        [XmlArrayItem("FilesToDeleteRegEx")]
        public Collection<string> FilesToDelete { get; set; }

        [XmlArrayItem("DiskToSkip")]
        public Collection<string> DisksToSkipOnRestore { get; set; }

        [XmlArrayItem("Monitor")]
        public Collection<ProcessServiceMonitor> Monitors { get; set; }
        ...
        private void LogPropertiesForType(object obj)
        {
            ...
            else
            {
                foreach (PropertyInfo property in properties)
                {
                         ...
                         )
                    {
                        ...
                        ICollection propertyValues = (ICollection)property.GetValue(obj);
